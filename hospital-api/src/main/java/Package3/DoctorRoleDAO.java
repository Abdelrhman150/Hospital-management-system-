...
public class DoctorRoleDAO {
     ...
     */
    public void assignRoleToDoctor(String doctorId, String roleName) throws Exception {
     ...
     */
    public ArrayList<String> getRolesForDoctor(String doctorId) throws Exception {
     ...
     */
    public void removeRoleFromDoctor(String doctorId, String roleName) throws Exception {
